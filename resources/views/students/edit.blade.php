  ...
  <div class="form-group row">
    ...
    <div class="col-sm-10">
        <div class="form-check form-check-inline">
            ...
            @if($student->gender== 'm' ) checked  @endif>
            <label class="form-check-label" for="inlineRadio1">Male</label>
        </div>
        <div class="form-check form-check-inline">
            <input class="form-check-input" type="radio" name="gender" id="inlineRadio2" value="f"
            @if($student->gender== 'f' ) checked  @endif>
...
<div class="form-group">
    ...
    <select class="form-control" name="teacherid" id="exampleSelect">
      ...
      <option value="{{ $teacher->id }}" @if($student->teacherId ==$teacher->id ) selected @endif>{{ $teacher->fullname }}</option>
      @endforeach
    </select>
</div>
